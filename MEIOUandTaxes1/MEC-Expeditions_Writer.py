...
expedition_duration = 282  # normal 282, change to 3 for testing
...
expeditions_list[-1].set_node_tech_reqs([('Iberia', 15), ('Strait of Gibraltar', 15), ('West Mediterranean', 15), ('France', 13), ('Channel', 13), ('North Sea', 13), ('Barbary Coast', 15), ('Tyrrenean Sea', 15), ('Rhineland', 13), ('Lower Nile', 15), ('Po Valley', 15), ('Adriatic Sea', 15), ('Levant', 15), ('Aegean Sea', 15),
                                         ...
                                         18), ('Lake Tchad', 18), ('Kongo', 18), ('South Africa', 20), ('Monomotapa', 20), ('Zanj', 20), ('Red Sea', 22), ('Upper Nile', 22), ('Arabia', 22), ('Iran', 22), ('Khorasan', 22), ('Mawarannahr', 22), ('Yettishar', 22),
...
expeditions_list[-1].set_node_tech_reqs([('Iberia', 13), ('Strait of Gibraltar', 15), ('West Mediterranean', 15), ('France', 13), ('Channel', 13), ('North Sea', 13), ('Barbary Coast', 15), ('Tyrrenean Sea', 15), ('Rhineland', 13), ('Lower Nile', 15), ('Po Valley', 15), ('Adriatic Sea', 15), ('Levant', 15), ('Aegean Sea', 15),
                                         ('Danube', 15), ('Elbe', 13), ('Baltic Sea', 15), ('Vistula', 15), ('Crimea', 15), ('Western Siberia', 15), ('Dnieper', 15), ('Caspian Sea', 15), ('Zalesye', 15), ('Anatolia', 15), ('Sahara', 15), ('Senegambia', 17), ('Niger River', 17), ('Guinea Coast',
                                         18), ('Lake Tchad', 18), ('Kongo', 18), ('South Africa', 20), ('Monomotapa', 20), ('Zanj', 20), ('Red Sea', 22), ('Upper Nile', 22), ('Arabia', 22), ('Iran', 22), ('Khorasan', 22), ('Mawarannahr', 22), ('Yettishar', 22),
                                         ('Punjab', 22), ('Gurjaratra', 22), ('Konkan', 22), ('Deccan Plateau', 22), ('Tamilakam', 22), ('Kalinga', 22), ('Delhi', 22), ('Bihar', 22), ('Bengal', 22), ('Himalayan Plateau', 22), ('Ayeyarwady', 22), ('Chao Phraya', 23), ('Malacca Strait', 23), ('Mekong', 23), ('Moluccas', 23),
                                         ('Champa Sea', 23), ('Australia', 23), ('Liangguang', 23), ('Szechwan', 23), ('Huazhong', 23), ('Jiangnan', 23), ('Huabei', 23), ('Xibei', 23), ('Zhongyuan', 23), ('Eastern Siberia', 23), ('Nippon', 23),
...
expeditions_list[-1].set_node_tech_reqs([('Iberia', 13), ('Strait of Gibraltar', 13), ('West Mediterranean', 15), ('France', 15), ('Channel', 15), ('North Sea', 15), ('Barbary Coast', 15), ('Tyrrenean Sea', 15), ('Rhineland', 15), ('Lower Nile', 15), ('Po Valley', 15), ('Adriatic Sea', 15), ('Levant', 15), ('Aegean Sea', 15),
...
expeditions_list[-1].set_node_tech_reqs([('Iberia', 13), ('Strait of Gibraltar', 13), ('West Mediterranean', 15), ('France', 15), ('Channel', 15), ('North Sea', 15), ('Barbary Coast', 15), ('Tyrrenean Sea', 15), ('Rhineland', 15), ('Lower Nile', 15), ('Po Valley', 15), ('Adriatic Sea', 15), ('Levant', 15), ('Aegean Sea', 15),
                                         ...
                                         17), ('Lake Tchad', 17), ('Kongo', 18), ('South Africa', 20), ('Monomotapa', 20), ('Zanj', 20), ('Red Sea', 22), ('Upper Nile', 22), ('Arabia', 22), ('Iran', 22), ('Khorasan', 22), ('Mawarannahr', 22), ('Yettishar', 22),
                                         ('Punjab', 22), ('Gurjaratra', 22), ('Konkan', 22), ('Deccan Plateau', 22), ('Tamilakam', 22), ('Kalinga', 22), ('Delhi', 22), ('Bihar', 22), ('Bengal', 22), ('Himalayan Plateau', 22), ('Ayeyarwady', 22), ('Chao Phraya', 22), ('Malacca Strait', 22), ('Mekong', 22), ('Moluccas', 22),
                                         ('Champa Sea', 22), ('Australia', 23), ('Liangguang', 23), ('Szechwan', 23), ('Huazhong', 23), ('Jiangnan', 23), ('Huabei', 23), ('Xibei', 23), ('Zhongyuan', 23), ('Eastern Siberia', 23), ('Nippon', 23),
                                         ('Far East', 23), ('Andes', 22), ('Southern Cone', 21), ('Guiana', 20), ('Amazonia', 22), ('Panama', 21), ('Caribbean', 19), ('Mexico', 21), ('Rio Grande', 21), ('Mississippi', 21), ('Plains', 21), ('Eastern Seaboard', 19), ('Canada', 19),
                                         ('American West Coast', 23), ('Pacific', 33)])
...
expeditions_list[-1].set_node_tech_reqs([('Iberia', 16), ('Strait of Gibraltar', 16), ('Sahara', 16), ('West Mediterranean', 17), ('France', 17), ('Channel', 17), ('North Sea', 17), ('Barbary Coast', 17), ('Tyrrenean Sea', 17), ('Rhineland', 17), ('Lower Nile', 17), ('Po Valley', 17), ('Adriatic Sea', 17), ('Levant', 17),
                                         ...
                                         13), ('Lake Tchad', 13), ('Kongo', 15), ('South Africa', 17), ('Monomotapa', 18), ('Zanj', 18), ('Red Sea', 20), ('Upper Nile', 20), ('Arabia', 20), ('Iran', 20), ('Khorasan', 20), ('Mawarannahr', 20), ('Yettishar', 20),
...
expeditions_list[-1].set_node_tech_reqs([('Iberia', 17), ('Strait of Gibraltar', 17), ('Sahara', 16), ('West Mediterranean', 18), ('France', 18), ('Channel', 18), ('North Sea', 18), ('Barbary Coast', 18), ('Tyrrenean Sea', 18), ('Rhineland', 18), ('Lower Nile', 18), ('Po Valley', 18), ('Adriatic Sea', 18), ('Levant',18),
                                         ...
                                         13), ('Lake Tchad', 13), ('Kongo', 13), ('South Africa', 17), ('Monomotapa', 17), ('Zanj', 17), ('Red Sea', 20), ('Upper Nile', 20), ('Arabia', 21), ('Iran', 21), ('Khorasan', 21), ('Mawarannahr', 21), ('Yettishar', 21),
...
expeditions_list[-1].set_node_tech_reqs([('Iberia', 18), ('Strait of Gibraltar', 18), ('Sahara', 17), ('West Mediterranean', 19), ('France', 19),
                                         ...
                                         13), ('Lake Tchad', 13), ('Kongo', 13), ('South Africa', 15), ('Monomotapa', 17), ('Zanj', 17), ('Red Sea', 19), ('Upper Nile', 19), ('Arabia', 20), ('Iran', 20), ('Khorasan', 20), ('Mawarannahr', 20), ('Yettishar', 20),
                                         ('Punjab', 20), ('Gurjaratra', 20), ('Konkan', 20), ('Deccan Plateau', 20), ('Tamilakam', 20), ('Kalinga', 20), ('Delhi', 20), ('Bihar', 20), ('Bengal', 20), ('Himalayan Plateau', 20), ('Ayeyarwady', 20), ('Chao Phraya', 20), ('Malacca Strait', 20), ('Mekong', 20), ('Moluccas', 20),
...
expeditions_list[-1].set_node_tech_reqs([('Iberia', 20), ('Strait of Gibraltar', 20), ('Sahara', 18), ('West Mediterranean', 20), ('France', 20), ('Channel', 20), ('North Sea', 20), ('Barbary Coast', 20), ('Tyrrenean Sea', 20), ('Rhineland', 20), ('Lower Nile', 20), ('Po Valley', 20), ('Adriatic Sea', 20), ('Levant', 20),
                                         ...
                                         17), ('Lake Tchad', 17), ('Kongo', 15), ('South Africa', 13), ('Monomotapa', 15), ('Zanj', 15), ('Red Sea', 16), ('Upper Nile', 16), ('Arabia', 17), ('Iran', 17), ('Khorasan', 17), ('Mawarannahr', 17), ('Yettishar', 17),
...
expeditions_list[-1].set_node_tech_reqs([('Iberia', 20), ('Strait of Gibraltar', 20), ('Sahara', 20), ('West Mediterranean', 20), ('France', 20), ('Channel', 20), ('North Sea', 20), ('Barbary Coast', 20), ('Tyrrenean Sea', 20), ('Rhineland', 20), ('Lower Nile', 18), ('Po Valley', 20), ('Adriatic Sea', 20), ('Levant', 20),
                                         ('Aegean Sea', 20), ('Danube', 20), ('Elbe', 20), ('Baltic Sea', 20),
                                         ...
                                         17), ('Lake Tchad', 18), ('Kongo', 17), ('South Africa', 15), ('Monomotapa', 13), ('Zanj', 13), ('Red Sea', 13), ('Upper Nile', 13), ('Arabia', 15), ('Iran', 16), ('Khorasan', 16), ('Mawarannahr', 16), ('Yettishar', 16),
...
expeditions_list[-1].set_node_tech_reqs([('Iberia', 20), ('Strait of Gibraltar', 20), ('Sahara', 20), ('West Mediterranean', 20), ('France', 20), ('Channel', 20), ('North Sea', 20), ('Barbary Coast', 20), ('Tyrrenean Sea', 20), ('Rhineland', 20), ('Lower Nile', 18), ('Po Valley', 20), ('Adriatic Sea', 20), ('Levant', 20),
                                         ('Aegean Sea', 20), ('Danube', 20), ('Elbe', 20), ('Baltic Sea', 20),
                                         ('Vistula', 20), ('Crimea', 20), ('Western Siberia', 20), ('Dnieper', 20), ('Caspian Sea', 20), ('Zalesye', 20), ('Anatolia', 20), ('Senegambia', 18), ('Niger River', 18), ('Guinea Coast',
                                         17), ('Lake Tchad', 18), ('Kongo', 17), ('South Africa', 15), ('Monomotapa', 13), ('Zanj', 13), ('Red Sea', 15), ('Upper Nile', 15), ('Arabia', 17), ('Iran', 17), ('Khorasan', 17), ('Mawarannahr', 17), ('Yettishar', 17),
...
expeditions_list[-1].set_node_tech_reqs(
    [('Iberia', 20), ('Strait of Gibraltar', 20), ('Sahara', 20), ('West Mediterranean', 20), ('France', 20), ('Channel', 20), ('North Sea', 20), ('Barbary Coast', 20), ('Tyrrenean Sea', 20), ('Rhineland', 20), ('Lower Nile', 16), ('Po Valley', 20), ('Adriatic Sea', 20), ('Levant', 20),
                                         ('Aegean Sea', 20), ('Danube', 20), ('Elbe', 20), ('Baltic Sea', 20),
                                         ...
                                         20), ('Lake Tchad', 20), ('Kongo', 20), ('South Africa', 17), ('Monomotapa', 16), ('Zanj', 15), ('Red Sea', 13), ('Upper Nile', 13), ('Arabia', 13), ('Iran', 13), ('Khorasan', 13), ('Mawarannahr', 13), ('Yettishar', 13),
...
expeditions_list[-1].set_node_tech_reqs(
    [('Iberia', 20), ('Strait of Gibraltar', 20), ('Sahara', 20), ('West Mediterranean', 20), ('France', 20), ('Channel', 20), ('North Sea', 20), ('Barbary Coast', 20), ('Tyrrenean Sea', 20), ('Rhineland', 20), ('Lower Nile', 18), ('Po Valley', 20), ('Adriatic Sea', 20), ('Levant', 20),
                                         ('Aegean Sea', 20), ('Danube', 20), ('Elbe', 20), ('Baltic Sea', 20),
                                         ('Vistula', 20), ('Crimea', 20), ('Western Siberia', 20), ('Dnieper', 20), ('Caspian Sea', 20), ('Zalesye', 20), ('Anatolia', 20), ('Senegambia', 20), ('Niger River', 20), ('Guinea Coast',
                                         20), ('Lake Tchad', 20), ('Kongo', 20), ('South Africa', 18), ('Monomotapa', 17), ('Zanj', 17), ('Red Sea', 15), ('Upper Nile', 15), ('Arabia', 13), ('Iran', 15), ('Khorasan', 15), ('Mawarannahr', 13), ('Yettishar', 13),
...
expeditions_list[-1].set_node_tech_reqs(
    [('Iberia', 20), ('Strait of Gibraltar', 20), ('Sahara', 20), ('West Mediterranean', 20), ('France', 20), ('Channel', 20), ('North Sea', 20), ('Barbary Coast', 20), ('Tyrrenean Sea', 20), ('Rhineland', 20), ('Lower Nile', 18), ('Po Valley', 20), ('Adriatic Sea', 20), ('Levant', 20),
                                         ('Aegean Sea', 20), ('Danube', 20), ('Elbe', 20), ('Baltic Sea', 20),
                                         ('Vistula', 20), ('Crimea', 20), ('Western Siberia', 20), ('Dnieper', 20), ('Caspian Sea', 20), ('Zalesye', 20), ('Anatolia', 20), ('Senegambia', 20), ('Niger River', 20), ('Guinea Coast',
                                         20), ('Lake Tchad', 20), ('Kongo', 20), ('South Africa', 18), ('Monomotapa', 17), ('Zanj', 17), ('Red Sea', 15), ('Upper Nile', 15), ('Arabia', 15), ('Iran', 15), ('Khorasan', 15), ('Mawarannahr', 15), ('Yettishar', 15),
...
expeditions_list[-1].set_node_tech_reqs(
    [('Iberia', 20), ('Strait of Gibraltar', 20), ('Sahara', 20), ('West Mediterranean', 20), ('France', 20), ('Channel', 20), ('North Sea', 20), ('Barbary Coast', 20), ('Tyrrenean Sea', 20), ('Rhineland', 20), ('Lower Nile', 18), ('Po Valley', 20), ('Adriatic Sea', 20), ('Levant', 20),
                                         ('Aegean Sea', 20), ('Danube', 20), ('Elbe', 20), ('Baltic Sea', 20),
                                         ('Vistula', 20), ('Crimea', 20), ('Western Siberia', 20), ('Dnieper', 20), ('Caspian Sea', 20), ('Zalesye', 20), ('Anatolia', 20), ('Senegambia', 20), ('Niger River', 20), ('Guinea Coast',
                                         20), ('Lake Tchad', 20), ('Kongo', 20), ('South Africa', 18), ('Monomotapa', 17), ('Zanj', 17), ('Red Sea', 16), ('Upper Nile', 16), ('Arabia', 15), ('Iran', 15), ('Khorasan', 15), ('Mawarannahr', 15), ('Yettishar', 15),
...
expeditions_list[-1].set_node_tech_reqs([('Iberia', 21), ('Strait of Gibraltar', 21), ('Sahara', 21), ('West Mediterranean', 21), ('France', 21), ('Channel', 21), ('North Sea', 21), ('Barbary Coast', 21), ('Tyrrenean Sea', 21), ('Rhineland', 21), ('Lower Nile', 19), ('Po Valley', 21), ('Adriatic Sea', 21), ('Levant', 21),
                                         ...
                                         21), ('Lake Tchad', 21), ('Kongo', 21), ('South Africa', 20), ('Monomotapa', 20), ('Zanj', 20), ('Red Sea', 17), ('Upper Nile', 17), ('Arabia', 17), ('Iran', 17), ('Khorasan', 17), ('Mawarannahr', 17), ('Yettishar', 17),
...
expeditions_list[-1].set_node_tech_reqs([('Iberia', 49), ('Strait of Gibraltar', 49), ('Sahara', 49), ('West Mediterranean', 49), ('France', 49), ('Channel', 49), ('North Sea', 49), ('Barbary Coast', 49), ('Tyrrenean Sea', 49), ('Rhineland', 49), ('Lower Nile', 49), ('Po Valley', 49), ('Adriatic Sea', 49), ('Levant', 49),
                                         ...
                                         49), ('Lake Tchad', 49), ('Kongo', 49), ('South Africa', 49), ('Monomotapa', 49), ('Zanj', 49), ('Red Sea', 49), ('Upper Nile', 49), ('Arabia', 49), ('Iran', 49), ('Khorasan', 49), ('Mawarannahr', 49), ('Yettishar', 49),
...
expeditions_list[-1].set_node_tech_reqs([('Iberia', 48), ('Strait of Gibraltar', 48), ('Sahara', 48), ('West Mediterranean', 48), ('France', 48), ('Channel', 48), ('North Sea', 48), ('Barbary Coast', 48), ('Tyrrenean Sea', 48), ('Rhineland', 48), ('Lower Nile', 48), ('Po Valley', 48), ('Adriatic Sea', 48), ('Levant', 48),
                                         ...
                                         48), ('Lake Tchad', 48), ('Kongo', 48), ('South Africa', 48), ('Monomotapa', 48), ('Zanj', 48), ('Red Sea', 48), ('Upper Nile', 48), ('Arabia', 48), ('Iran', 48), ('Khorasan', 48), ('Mawarannahr', 48), ('Yettishar', 48),
...
expeditions_list[-1].set_node_tech_reqs(
    [('Iberia', 33), ('Strait of Gibraltar', 33), ('Sahara', 33), ('West Mediterranean', 33), ('France', 33), ('Channel', 33), ('North Sea', 33), ('Barbary Coast', 33), ('Tyrrenean Sea', 33), ('Rhineland', 33), ('Lower Nile', 33), ('Po Valley', 33), ('Adriatic Sea', 33), ('Levant', 33),
                                         ...
                                         33), ('Lake Tchad', 33), ('Kongo', 33), ('South Africa', 33), ('Monomotapa', 33), ('Zanj', 33), ('Red Sea', 33), ('Upper Nile', 33), ('Arabia', 33), ('Iran', 33), ('Khorasan', 33), ('Mawarannahr', 33), ('Yettishar', 33),
...
expeditions_list[-1].set_node_tech_reqs([('Iberia', 22), ('Strait of Gibraltar', 22), ('Sahara', 22), ('West Mediterranean', 22), ('France', 22), ('Channel', 22), ('North Sea', 22), ('Barbary Coast', 22), ('Tyrrenean Sea', 22), ('Rhineland', 22), ('Lower Nile', 20), ('Po Valley', 22), ('Adriatic Sea', 22), ('Levant', 22),
                                         ...
                                         22), ('Lake Tchad', 22), ('Kongo', 22), ('South Africa', 21), ('Monomotapa', 21), ('Zanj', 21), ('Red Sea', 19), ('Upper Nile', 19), ('Arabia', 19), ('Iran', 19), ('Khorasan', 19), ('Mawarannahr', 19), ('Yettishar', 19),
...
expeditions_list[-1].set_node_tech_reqs([('Iberia', 22), ('Strait of Gibraltar', 22), ('Sahara', 22), ('West Mediterranean', 22), ('France', 22), ('Channel', 22), ('North Sea', 22), ('Barbary Coast', 22), ('Tyrrenean Sea', 22), ('Rhineland', 22), ('Lower Nile', 20), ('Po Valley', 22), ('Adriatic Sea', 22), ('Levant', 22),
                                         ('Aegean Sea', 22), ('Danube', 22), ('Elbe', 22), ('Baltic Sea', 22),
                                         ('Vistula', 22), ('Crimea', 22), ('Western Siberia', 22), ('Dnieper', 22), ('Caspian Sea', 22), ('Zalesye', 22), ('Anatolia', 22), ('Senegambia', 22), ('Niger River', 22), ('Guinea Coast',
                                         22), ('Lake Tchad', 22), ('Kongo', 22), ('South Africa', 21), ('Monomotapa', 21), ('Zanj', 21), ('Red Sea', 20), ('Upper Nile', 20), ('Arabia', 20), ('Iran', 20), ('Khorasan', 20), ('Mawarannahr', 20), ('Yettishar', 20),
...
expeditions_list[-1].set_node_tech_reqs([('Iberia', 19), ('Strait of Gibraltar', 19), ('Sahara', 19), ('West Mediterranean', 19), ('France', 19), ('Channel', 19), ('North Sea', 19), ('Barbary Coast', 20), ('Tyrrenean Sea', 20), ('Rhineland', 20), ('Lower Nile', 20), ('Po Valley', 20), ('Adriatic Sea', 20), ('Levant', 20),
                                         ('Aegean Sea', 20), ('Danube', 20), ('Elbe', 20), ('Baltic Sea', 20),
                                         ...
                                         19), ('Lake Tchad', 19), ('Kongo', 19), ('South Africa', 20), ('Monomotapa', 20), ('Zanj', 20), ('Red Sea', 21), ('Upper Nile', 21), ('Arabia', 22), ('Iran', 22), ('Khorasan', 22), ('Mawarannahr', 22), ('Yettishar', 22),
                                         ('Punjab', 22), ('Gurjaratra', 22), ('Konkan', 22), ('Deccan Plateau', 22), ('Tamilakam', 22), ('Kalinga', 22), ('Delhi', 22), ('Bihar', 22), ('Bengal', 22), ('Himalayan Plateau', 22), ('Ayeyarwady', 22), ('Chao Phraya', 22), ('Malacca Strait', 22), ('Mekong', 22), ('Moluccas', 22),
...
expeditions_list[-1].set_node_tech_reqs(
    [('Iberia', 20), ('Strait of Gibraltar', 20), ('Sahara', 20), ('West Mediterranean', 20), ('France', 20), ('Channel', 20), ('North Sea', 20), ('Barbary Coast', 20), ('Tyrrenean Sea', 20), ('Rhineland', 20), ('Lower Nile', 20), ('Po Valley', 20), ('Adriatic Sea', 20), ('Levant', 20),
                                         ('Aegean Sea', 20), ('Danube', 20), ('Elbe', 20), ('Baltic Sea', 20),
                                         ('Vistula', 20), ('Crimea', 20), ('Western Siberia', 20), ('Dnieper', 20), ('Caspian Sea', 20), ('Zalesye', 20), ('Anatolia', 20), ('Senegambia', 20), ('Niger River', 20), ('Guinea Coast',
                                         20), ('Lake Tchad', 20), ('Kongo', 20), ('South Africa', 21), ('Monomotapa', 21), ('Zanj', 21), ('Red Sea', 23), ('Upper Nile', 23), ('Arabia', 23), ('Iran', 23), ('Khorasan', 23), ('Mawarannahr', 23), ('Yettishar', 23),
...
expeditions_list[-1].set_node_tech_reqs([('Iberia', 21), ('Strait of Gibraltar', 21), ('Sahara', 21), ('West Mediterranean', 21), ('France', 21), ('Channel', 21), ('North Sea', 21), ('Barbary Coast', 21), ('Tyrrenean Sea', 21), ('Rhineland', 21), ('Lower Nile', 21), ('Po Valley', 21), ('Adriatic Sea', 21), ('Levant', 21),
                                         ('Aegean Sea', 21), ('Danube', 21), ('Elbe', 21), ('Baltic Sea', 21),
                                         ('Vistula', 21), ('Crimea', 21), ('Western Siberia', 21), ('Dnieper', 21), ('Caspian Sea', 21), ('Zalesye', 21), ('Anatolia', 21), ('Senegambia', 21), ('Niger River', 21), ('Guinea Coast',
                                         21), ('Lake Tchad', 21), ('Kongo', 21), ('South Africa', 21), ('Monomotapa', 21), ('Zanj', 21), ('Red Sea', 23), ('Upper Nile', 23), ('Arabia', 23), ('Iran', 23), ('Khorasan', 23), ('Mawarannahr', 23), ('Yettishar', 23),
                                         ('Punjab', 23), ('Gurjaratra', 23), ('Konkan', 23), ('Deccan Plateau', 23), ('Tamilakam', 23), ('Kalinga', 23), ('Delhi', 23), ('Bihar', 23), ('Bengal', 23), ('Himalayan Plateau', 23), ('Ayeyarwady', 23), ('Chao Phraya', 23), ('Malacca Strait', 23), ('Mekong', 23), ('Moluccas', 23),
                                         ('Champa Sea', 23), ('Australia', 23), ('Liangguang', 23), ('Szechwan', 23), ('Huazhong', 23), ('Jiangnan', 23), ('Huabei', 23), ('Xibei', 23), ('Zhongyuan', 23), ('Eastern Siberia', 23), ('Nippon', 23),
...
expeditions_list[-1].set_node_tech_reqs(
    [('Iberia', 20), ('Strait of Gibraltar', 20), ('Sahara', 20), ('West Mediterranean', 20), ('France', 20), ('Channel', 20), ('North Sea', 20), ('Barbary Coast', 20), ('Tyrrenean Sea', 20), ('Rhineland', 20), ('Lower Nile', 20), ('Po Valley', 20), ('Adriatic Sea', 20), ('Levant', 20),
                                         ('Aegean Sea', 20), ('Danube', 20), ('Elbe', 20), ('Baltic Sea', 20),
                                         ('Vistula', 20), ('Crimea', 20), ('Western Siberia', 20), ('Dnieper', 20), ('Caspian Sea', 20), ('Zalesye', 20), ('Anatolia', 20), ('Senegambia', 17), ('Niger River', 17), ('Guinea Coast',
                                         17), ('Lake Tchad', 17), ('Kongo', 18), ('South Africa', 19), ('Monomotapa', 20), ('Zanj', 20), ('Red Sea', 20), ('Upper Nile', 20), ('Arabia', 21), ('Iran', 21), ('Khorasan', 21), ('Mawarannahr', 21), ('Yettishar', 21),
                                         ('Punjab', 21), ('Gurjaratra', 21), ('Konkan', 21), ('Deccan Plateau', 21), ('Tamilakam', 21), ('Kalinga', 21), ('Delhi', 21), ('Bihar', 21), ('Bengal', 21), ('Himalayan Plateau', 21), ('Ayeyarwady', 21), ('Chao Phraya', 21), ('Malacca Strait', 21), ('Mekong', 21), ('Moluccas', 21),
                                         ('Champa Sea', 21), ('Australia', 22), ('Liangguang', 22), ('Szechwan', 22), ('Huazhong', 22), ('Jiangnan', 22), ('Huabei', 22), ('Xibei', 22), ('Zhongyuan', 22), ('Eastern Siberia', 22), ('Nippon', 22),
...
expeditions_list[-1].set_node_tech_reqs([('Iberia', 25), ('Strait of Gibraltar', 25), ('Sahara', 25), ('West Mediterranean', 25), ('France', 25), ('Channel', 25), ('North Sea', 25), ('Barbary Coast', 25), ('Tyrrenean Sea', 25), ('Rhineland', 25), ('Lower Nile', 25), ('Po Valley', 25), ('Adriatic Sea', 25), ('Levant', 25),
                                         ...
                                         25), ('Lake Tchad', 25), ('Kongo', 25), ('South Africa', 25), ('Monomotapa', 25), ('Zanj', 25), ('Red Sea', 25), ('Upper Nile', 25), ('Arabia', 25), ('Iran', 25), ('Khorasan', 25), ('Mawarannahr', 25), ('Yettishar', 25),
...
expeditions_list[-1].set_node_tech_reqs([('Iberia', 23), ('Strait of Gibraltar', 23), ('Sahara', 23), ('West Mediterranean', 23), ('France', 23), ('Channel', 23), ('North Sea', 23), ('Barbary Coast', 23), ('Tyrrenean Sea', 23), ('Rhineland', 23), ('Lower Nile', 23), ('Po Valley', 23), ('Adriatic Sea', 23), ('Levant', 23),
                                         ...
                                         23), ('Lake Tchad', 23), ('Kongo', 23), ('South Africa', 23), ('Monomotapa', 23), ('Zanj', 23), ('Red Sea', 23), ('Upper Nile', 23), ('Arabia', 23), ('Iran', 23), ('Khorasan', 23), ('Mawarannahr', 23), ('Yettishar', 23),
                                         ('Punjab', 23), ('Gurjaratra', 23), ('Konkan', 23), ('Deccan Plateau', 23), ('Tamilakam', 23), ('Kalinga', 23), ('Delhi', 23), ('Bihar', 23), ('Bengal', 23), ('Himalayan Plateau', 23), ('Ayeyarwady', 23), ('Chao Phraya', 23), ('Malacca Strait', 23), ('Mekong', 23), ('Moluccas', 23),
                                         ('Champa Sea', 23), ('Australia', 23), ('Liangguang', 23), ('Szechwan', 23), ('Huazhong', 23), ('Jiangnan', 23), ('Huabei', 23), ('Xibei', 23), ('Zhongyuan', 23), ('Eastern Siberia', 23), ('Nippon', 23),
...
expeditions_list[-1].set_node_tech_reqs([('Iberia', 30), ('Strait of Gibraltar', 30), ('Sahara', 30), ('West Mediterranean', 30), ('France', 30), ('Channel', 30), ('North Sea', 30), ('Barbary Coast', 30), ('Tyrrenean Sea', 30), ('Rhineland', 30), ('Lower Nile', 30), ('Po Valley', 30), ('Adriatic Sea', 30), ('Levant', 30),
                                         ...
                                         30), ('Lake Tchad', 30), ('Kongo', 30), ('South Africa', 30), ('Monomotapa', 30), ('Zanj', 30), ('Red Sea', 30), ('Upper Nile', 30), ('Arabia', 30), ('Iran', 30), ('Khorasan', 30), ('Mawarannahr', 30), ('Yettishar', 30),
...
expeditions_list[-1].set_node_tech_reqs([('Iberia', 35), ('Strait of Gibraltar', 35), ('Sahara', 35), ('West Mediterranean', 35), ('France', 35), ('Channel', 35), ('North Sea', 35), ('Barbary Coast', 35), ('Tyrrenean Sea', 35), ('Rhineland', 35), ('Lower Nile', 35), ('Po Valley', 35), ('Adriatic Sea', 35), ('Levant', 35),
                                         ...
                                         35), ('Lake Tchad', 35), ('Kongo', 35), ('South Africa', 35), ('Monomotapa', 35), ('Zanj', 35), ('Red Sea', 35), ('Upper Nile', 35), ('Arabia', 35), ('Iran', 35), ('Khorasan', 35), ('Mawarannahr', 35), ('Yettishar', 35),
...
expeditions_list[-1].set_node_tech_reqs([('Iberia', 23), ('Strait of Gibraltar', 23), ('Sahara', 23), ('West Mediterranean', 23), ('France', 23), ('Channel', 23), ('North Sea', 23), ('Barbary Coast', 23), ('Tyrrenean Sea', 23), ('Rhineland', 23), ('Lower Nile', 23), ('Po Valley', 23), ('Adriatic Sea', 23), ('Levant', 23),
                                         ...
                                         20), ('Lake Tchad', 20), ('Kongo', 21), ('South Africa', 23), ('Monomotapa', 23), ('Zanj', 23), ('Red Sea', 23), ('Upper Nile', 23), ('Arabia', 23), ('Iran', 23), ('Khorasan', 23), ('Mawarannahr', 23), ('Yettishar', 23),
                                         ('Punjab', 23), ('Gurjaratra', 23), ('Konkan', 23), ('Deccan Plateau', 23), ('Tamilakam', 23), ('Kalinga', 23), ('Delhi', 23), ('Bihar', 23), ('Bengal', 23), ('Himalayan Plateau', 23), ('Ayeyarwady', 23), ('Chao Phraya', 23), ('Malacca Strait', 23), ('Mekong', 23), ('Moluccas', 23),
                                         ('Champa Sea', 23), ('Australia', 23), ('Liangguang', 23), ('Szechwan', 23), ('Huazhong', 23), ('Jiangnan', 23), ('Huabei', 23), ('Xibei', 23), ('Zhongyuan', 23), ('Eastern Siberia', 23), ('Nippon', 23),
...
expeditions_list[-1].set_node_tech_reqs([('Iberia', 30), ('Strait of Gibraltar', 30), ('Sahara', 30), ('West Mediterranean', 30), ('France', 30), ('Channel', 30), ('North Sea', 30), ('Barbary Coast', 30), ('Tyrrenean Sea', 30), ('Rhineland', 30), ('Lower Nile', 30), ('Po Valley', 30), ('Adriatic Sea', 30), ('Levant', 30),
                                         ('Aegean Sea', 30), ('Danube', 30), ('Elbe', 30), ('Baltic Sea', 30),
                                         ('Vistula', 30), ('Crimea', 30), ('Western Siberia', 30), ('Dnieper', 30), ('Caspian Sea', 30), ('Zalesye', 30), ('Anatolia', 30), ('Senegambia', 30), ('Niger River', 30), ('Guinea Coast',
                                         30), ('Lake Tchad', 30), ('Kongo', 30), ('South Africa', 30), ('Monomotapa', 30), ('Zanj', 30), ('Red Sea', 25), ('Upper Nile', 25), ('Arabia', 25), ('Iran', 25), ('Khorasan', 25), ('Mawarannahr', 25), ('Yettishar', 25),
...
expeditions_list[-1].set_node_tech_reqs([('Iberia', 37), ('Strait of Gibraltar', 37), ('Sahara', 37), ('West Mediterranean', 37), ('France', 37), ('Channel', 37), ('North Sea', 37), ('Barbary Coast', 37), ('Tyrrenean Sea', 37), ('Rhineland', 37), ('Lower Nile', 37), ('Po Valley', 37), ('Adriatic Sea', 37), ('Levant', 37),
                                         ...
                                         37), ('Lake Tchad', 37), ('Kongo', 37), ('South Africa', 37), ('Monomotapa', 37), ('Zanj', 37), ('Red Sea', 37), ('Upper Nile', 37), ('Arabia', 37), ('Iran', 37), ('Khorasan', 37), ('Mawarannahr', 37), ('Yettishar', 37),
...
trade_nodes = {'Pacific': 1, 'Australia': 2, 'Jiangnan': 3, 'Far East': 4, 'Eastern Siberia': 5, 'Huabei': 6, 'Nippon': 7, 
               ...
               'Elbe': 78, 'Tyrrenean Sea': 79, 'Sahara': 80, 'North Sea': 81 }
...
country_decisions = {
	...
	MEC_Expeditions_Decision = {
		major = no
		potential = { # Visible if have taken exploration ideas
			OR = {
...
country_event = {{
	...
	option = {{
		...
		if = {{ # Have to check again in case of change while expedition was in progress
			...
			event_target:MEC_Expedition_Target_Province = {{ # Call the event on the province that was found to be best
...
# Has variables: event_num, event_num_success, event_num_total_failure, expedition_name, event_num_no_attack_failure
	...
	immediate = {{
		hidden_effect = {{
			if = {{
				...
				change_key = {{ # Add fort bonus to owner tech
					lhs = Tmp_1
					which = Tmp_2
				}}
				if = {{
				...
				if = {{ # If manpower sum > 7 add 4 elif > 4 add 2 elif > 2 add 1
					limit = {{
						check_key = {{
							lhs = Tmp_3
							value = 7
				...
				if = {{ # If Land Province Size > 700 add 4 elif > 400 add 2 elif > 100 add 1
					limit = {{
						check_key = {{
							lhs = Land_Size
							value = 700
...
country_event = {{
	...
	immediate = {{
		hidden_effect = {{
			...
			FROM = {{ # FROM is the province, ROOT is the expedition sender
				...
				add_territorial_core = ROOT 
				save_event_target_as = expedition_province
				if = {{ # Change religion and culture if empty province not in trade company or in trade company with no population
					...
					ROOT = {{
						capital_scope = {{
							FROM = {{ set_key = {{ lhs = Plague_Resistance1 which = PREV }} }}
							FROM = {{ set_key = {{ lhs = Plague_Resistance2 which = PREV }} }}
							FROM = {{ set_key = {{ lhs = Plague_Resistance4 which = PREV }} }}
						    
						    FROM = {{ divide_key = {{ lhs = Plague_Resistance1 value = 3 }} }}
						    FROM = {{ divide_key = {{ lhs = Plague_Resistance2 value = 3 }} }}
						    FROM = {{ divide_key = {{ lhs = Plague_Resistance4 value = 3 }} }}
						}}
				...
				if = {{ # If not empty add negative opinion for owner against expedition sender
					...
					#log = "MEC_Expeditions:[GetYear]:[Root.GetName]:received negative opinion modifier from::[From.Owner.GetName]"
					owner = {{
						add_opinion = {{
							who = ROOT
...
expedition_success_confirmation_MAM_event_15 = """\
	option = {{
		...
		#log = "MEC_Expeditions:[GetYear]:[Root.GetName]:successful expedition to:{expedition_name}:[From.GetName]"
		add_prestige = 3
    ...
    with open(Path('localisation/MEC-Expeditions_l_english.yml'), 'w', encoding='utf-8-sig') as loc:
        ...
        for index, expedition in enumerate(expeditions_list):
            ...
            events.write(select_expedition_option_frame_bottom.format(expedition_name=expedition.name,
                                                         event_num_arrival=str(expedition_arrival_start_number + index).zfill(3), event_num_total_failure=str(expedition_total_failure_start_number + index).zfill(3), event_num_map_failure=str(expedition_map_failure_start_number + index).zfill(3),
        ...
        for index, expedition in enumerate(expeditions_list):
            ...
            events.write(expedition_landing_frame.format(event_num=str(expedition_landing_start_number + index).zfill(3), event_num_success=str(expedition_success_start_number + index).zfill(3), event_num_total_failure=str(expedition_total_failure_start_number + index).zfill(3),
                                                         expedition_name=expedition.name, event_num_no_attack_failure=str(expedition_no_attack_failure_start_number + index).zfill(3)))
            ...
            loc.write(f' MEC_Expeditions.{str(expedition_landing_start_number + index).zfill(3)}.desc: "Foreigners have arrived wanting to setup a trading fort on our our province of [Root.GetName]. This would effectively give them control of the province. They offer to pay for the province, '
                      f'but our diplomatic advisor suspects that if we don\'t accept they will try to take it by force anyway. Our military advisor estimates that if it comes down to a fight they have a [GV_MEC_Expeditions_Comparison] out of 10 chance of holding the province."\n')
        ...
        for index, expedition in enumerate(expeditions_list):
            ...
            loc.write(
                f' MEC_Expeditions.{str(expedition_success_start_number + index).zfill(3)}.desc: "We have heard back from the expedition to {expedition.localized_name}. They have established a settlement at [expedition_province.GetName]. Since they also control the surrounding area they are '
