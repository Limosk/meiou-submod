...
NDefines.NEconomy.AUTONOMY_AT_DIPLO_ANNEX = 20					-- Autonomy added when diplo-annexing
NDefines.NEconomy.AUTONOMY_AT_CONQUEST = 20						-- Autonomy added at conquest
NDefines.NEconomy.AUTONOMY_AT_CONQUEST_CLAIM = 10				-- Autonomy added at conquest if you have a claim
...
NDefines.NEconomy.COLONY_MIN_AUTONOMY = 0					-- Capital province autonomy can never be above this
NDefines.NEconomy.DECREASE_AUTONOMY_STEP = -5
NDefines.NEconomy.DECREASE_AUTONOMY_MIN = 1
NDefines.NEconomy.INCREASE_AUTONOMY_STEP = 5
NDefines.NEconomy.INCREASE_AUTONOMY_MAX = 99
NDefines.NEconomy.AUTONOMY_CHANGE_DURATION = 10950  				-- about 10 years
NDefines.NEconomy.MERCHANT_MAX_POWER_BONUS = 0.5					-- was 0.5
NDefines.NEconomy.LAND_TECH_MAINTENANCE_IMPACT = 0 				-- % each tech increases it.   #CHANGED FROM 0.05 BY DO OVERHAUL
NDefines.NEconomy.ADVISOR_COST = 0.10								-- Advisor cost modifier (was 1.0 by Khardinal)
...
NDefines.NEconomy.LIGHT_SHIP_MAINT_FACTOR = 0.10				-- _EDEF_LIGHT_SHIP_MAINT_FACTOR_
NDefines.NEconomy.GALLEY_MAINT_FACTOR = 0.10					-- _EDEF_GALLEY_MAINT_FACTOR_
NDefines.NEconomy.TRANSPORT_MAINT_FACTOR = 0.10					-- _EDEF_TRANSPORT_MAINT_FACTOR_
NDefines.NEconomy.COLONIAL_MAINTENANCE_FACTOR = 2.0				-- _EDEF_COLONIAL_MAINTENANCE_FACTOR_ # In vanilla is 8 which means 2 ducats/month at full slider
...
NDefines.NEconomy.TRADE_ADDED_VALUE_MODIFER = 0.0				-- This is actually multiplied by 2.26, because paradox.
NDefines.NEconomy.TRADE_PROPAGATE_DIVIDER = 20					-- was 5
...
NDefines.NEconomy.TRADE_COMPANY_STRONG_LIMIT = 0.10				-- Minimum share in trade node at which to give trade_company_strong static modifier to country
NDefines.NEconomy.LARGE_COLONIAL_NATION_LIMIT = 3				-- Thought this was connected to large_colonial_nation static modifier to overlord, however merchants from CNs seem broken (inconsistent) so can't tell. Vanilla is 10
...
NDefines.NEconomy.MAX_BUILDING_SLOTS = 49						-- vanilla 12, Maximum number of buildings slots, i.e. max buildings possible.
NDefines.NEconomy.DEBASE_MAX_STORED_MONTHS = 0					-- Debase currency stores up to this many months of charges.
NDefines.NEconomy.TRADE_NON_CAPITAL_OFFICE = 0				    -- TRADE_NON_CAPITAL_OFFICE
...
NDefines.NEconomy.MISSIONARY_TIME_BASE = 5000
NDefines.NEconomy.MISSIONARY_TIME_DISTANCE = 0.5
