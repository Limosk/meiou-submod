...
def gen_scripts(txt, tmplt, dct, out, encoding=None):
...
if __name__ == "__main__":  
    ...
    gen_scripts(effect, tmplt_effect, dct, os.path.join('common', 'scripted_effects', '00-scripts.txt'))
    gen_scripts(trigger, tmplt_trigger, dct, os.path.join('common', 'scripted_triggers', '00-triggers.txt'))
